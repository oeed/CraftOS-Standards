...
Already sure how should the final result look like? Great! You can start writing the docs for your upcoming standard. Make sure not to create a Pull Request ("PR") yet, as at this point your proposal doesn't yet match the [required template](https://github.com/oeed/CraftOS-Standards/blob/master/Standard%20Proposal%20Guidelines.md).
